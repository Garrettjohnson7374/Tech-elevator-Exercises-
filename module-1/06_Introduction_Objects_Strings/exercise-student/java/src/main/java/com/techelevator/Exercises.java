...
public class Exercises {
	...
	public String makeTags(String tag, String word) {
		...
		String wrapper = "<>";
		String wrapperEnd = "</>";
		String wrappedWord = (wrapper.substring(0, 1) + tag + wrapper.substring(1) + word + wrapperEnd.substring(0, 2) + tag + wrapperEnd.substring(2, 3));
		//this answer makes me uncomfortable with myself as a person but it works
		return wrappedWord;
	}
	...
	public String makeOutWord(String out, String word) {
		String finalWord = out.substring(0, 2) + word + out.substring(2, 4);
	...
	public String theEnd(String str, boolean front) {
		...
		if (!front) {
			String ifFalse = str.substring(str.length() - 1);
			return ifFalse;
		}
	...
	public String middleTwo(String str) {
		...
		String middle2 = str.substring(strLength / 2 - 1, strLength / 2 + 1);
		return middle2;
	}
	...
	public String middleThree(String str) {
		...
		String middle3 = str.substring(phraseLength / 2 - 1, phraseLength / 2 + 2);
		return middle3;
	}
	...
	public int last2(String str) {
		if (str.length() > 1) {
			...
			int endCount = 0;
			String endString = "";
			endString = str.substring(str.length() - 2);
			for (int i = 0; i < str.length() - 1; i++) {
				if (str.substring(i, i + 2).equals(endString)) {
					endCount++;
				}
			}
			return endCount - 1;
	...
	public String stringX(String str) {
		if (str.length() > 1) {
			...
			String end = str.substring(str.length() - 1);
				return begin + (str.substring(1, str.length() - 1).replaceAll("x", (""))) + end;
		}
		return str;
