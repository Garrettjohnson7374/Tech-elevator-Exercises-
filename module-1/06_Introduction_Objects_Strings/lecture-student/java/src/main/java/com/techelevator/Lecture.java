...
public class Lecture {
	...
	public String makeStringFromChars(char a, char b, char c) {
		...
		String output = new String(input);     //String made from Array
		return output;
	}
	...
	public String getLast3Letters(String input) {
		...
		// OR return input.substring(input.length() - 3);
	...
	public String removeFirstLetter(String input) {
		...
		return input.substring(1); // return all letters in string after the 0'th letter
	}
	...
	public boolean isDarthVader(String firstName, String lastName) {
		...
		return fullName.equals("Anakin Skywalker");  // changed == to .equals
	}
	...
	public String conCat(String a, String b) {
		...
		if (a.length() > 0 && b.length() > 0) {
			if (a.charAt(a.length() - 1) == b.charAt(0)) {
			    // if last letter of a equals first letter of b
