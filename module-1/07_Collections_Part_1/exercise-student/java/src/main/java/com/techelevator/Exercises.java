...
public class Exercises {
	...
	public String[] list2Array(List<String> stringList) {
		String [] arrString = stringList.toArray(new String[0]);
		return arrString;
	}
	...
	** INTERVIEW QUESTION **
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		List<Integer> listInterleave = new ArrayList<>();
			for( int i = 0; i < listOne.size() || i < listTwo.size(); i++){
			if(i < listOne.size()){
				listInterleave.add(listOne.get(i));
			}
				if(i < listTwo.size()) {
					listInterleave.add(listTwo.get(i));
				}
				int x =0 ;
		}
		return listInterleave;
	}
