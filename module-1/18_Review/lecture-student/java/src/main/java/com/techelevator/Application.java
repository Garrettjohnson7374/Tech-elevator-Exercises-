...
public class Application {
	...
	private static final  String MENU_OPTION_PERFORM_SEARCH = "CUSTOM INPUT SEARCH";
	...
	public void run() {
		...
		while (running) {
			...
			String customSearchtext = ui.promptForString("what would you like to search for? ");
			performSearch(customSearchtext);
			}
